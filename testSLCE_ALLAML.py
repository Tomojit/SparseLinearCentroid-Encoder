...
def classifyALLAMLData(D_tr,trLabels,D_tst,tstLabels,featureSet,fCntList,gpuId,pp):
...
if __name__ == "__main__":
	...
	for pp in range(20):
		...
		accuracyList = classifyALLAMLData(trData,trLabels,tstData,tstLabels,feaList,fCntList,cudaId,pp)
